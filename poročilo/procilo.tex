...
$N_2$, ki porabi $\mathcal{O}(\frac{n}{2} c^*)$ časa. V primeru,
 ...
 \par
 V tabeli je prikazana časovna zahtevnost algoritma v odvisnosti od $\Gamma$, $c$ in $n$, čas pa je merjen v sekundah.
 Meritve sva izvedla na naključno generiranih podatkih, dobljenih s funkcijo \textit{naredi\_podatke}. Vse meritve sva opravila 
 s prenosnim računalnikom Macbook (early 2016) s procesorjem 1,2 GHz Dual-Core Intel Core m5 in 8GB spomina.
 ...
 \begin{table}[]
    ...
    \end{tabular}
    \caption{\label{tab:Tabela 1}Časovna zahtevnost algortima v odvisnosti od $n$, $\Gamma$ in $c$.}
\end{table}
...
\par
Optimalne portfelje za delnice $S\&P 500$ sva izračunala za proračune $B = 50$, $B = 100$, $B = 500$,
$B = 1000$ in $B = 2000$. V tabeli je prikazana časovna zahtevnost za posamezne 
primere ter sestava optimalnega portfelja, pri čemer so imena podjetji zapisana z njihovimi
kraticami. 
\begin{table}[]
    \resizebox{\textwidth}{!}{
    ...
    \multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Sestava optimalnega\\ portfelja\end{tabular}} & \begin{tabular}[c]{@{}c@{}}CARR: 1, AMCR: 1,\\ HBAN: 1\end{tabular} & \begin{tabular}[c]{@{}c@{}}CARR: 2, ZION: 1,\\ HWM: 1, HFC: 1\end{tabular} & \begin{tabular}[c]{@{}c@{}}Carr: 4, Etsy: 2\\ Nwsa: 1, Intc: 1\end{tabular} & \begin{tabular}[c]{@{}c@{}}Etsy: 5, Carr: 4,\\ Vtrs: 1\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wts: 7, Wrk: 1,\\ Xyl: 1\end{tabular} \\ \hline
    \multicolumn{1}{|c|}{Dobiček}                                                                 & 123                                                                 & 272                                                                        & 1583                                                                        & 3246                                                                & 3477                                                             \\ \hline
    \end{tabular}}
    \caption{\label{tab: Tabela 2} Časovna zahtevnost finančnega RKP modela in dobljeni rezultati}
