...
\begin{table}[h]
    ...
    \multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Sestava optimalnega\\ portfelja\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Carr: 1, Amcr: 1 \end{tabular} & \begin{tabular}[c]{@{}c@{}}Carr: 2, Hwm: 1 \end{tabular} & \begin{tabular}[c]{@{}c@{}}Carr: 8, Hwm: 1\\ Etsy: 1 \end{tabular} & \begin{tabular}[c]{@{}c@{}}Etsy: 5, Carr: 4,\\ Vtrs: 1\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wst: 7, Wrk: 1,\\ Xyl: 1\end{tabular} \\ \hline
    \multicolumn{1}{|c|}{Dobiček}                                                                 & 75                                                                 & 173                                                                        & 1000                                                                        & 3246                                                                & 3477                                                             \\ \hline
    \end{tabular}}
